...
"""
Run the Adversarial Zipfian Parameter Test over multiple data structures.

Procedure:
- For each combination of n (size), alpha (Zipfian parameter), and error:
...
Side effects:
- Generates JSON files in the results/AdvZipfianTest directory.
